...
/**
 * View notifies Presenter that it is ready to be updated by calling the {@link BasePresenter#subscribe() presenter.subscribe()}
 * method of the Presenter in onResume. The View calls {@link BasePresenter#unsubscribe() presenter.unsubscribe()}
